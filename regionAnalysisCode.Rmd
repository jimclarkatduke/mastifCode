...
#val update : copy soil file from github to makemast folder 
file.copy(from="/home/journe/Documents/Server/journepostdoc/mastifCode/soil_data.csv", to=getwd(), 
          overwrite = TRUE)
