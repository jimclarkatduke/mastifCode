...
par(mfrow=c(1,2), bty='n', mar=c(4,4,2,1), omi=c(.5,.8,0,.5))

plot( dfScaled[[io[1]]][1,], dfScaled[[io[1]]][2,], xlim=c(0,2), ylim = c(0, 1),
      type='l', lwd=2, col = .getColor('black', width[io[1]]), xlab='',ylab = '' )
for(k in io){
  lines(dfScaled[[k]][1,], dfScaled[[k]][2,], lwd=2, col = .getColor('black', width[k]))
}
